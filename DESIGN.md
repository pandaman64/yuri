...
**最小限のリソース使用で最大限の性能を生み出す非同期ファーストプログラミング言語**
...
Rustを知っている人向け: Dropが非同期になることで非同期キャンセルが良い感じに扱えてio_uringを安全に叩けるRust

Goを知っている人向け: goroutineがリークせずGCが無いけど，ちょっと複雑な言語機能も入ってる（ジェネリクス，代数的データ型）Go
